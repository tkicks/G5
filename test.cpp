...
Scene scene;
/************************Class Methods***************************/
void Scene::makeCup(bool inside){

	float TxIncrem = 1.0/16;
    float Tx = 0.0;
...
{
	free(image);
	image=glmReadPPM (filename, &texWidth, &texHeight);
